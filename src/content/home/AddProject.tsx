...
const AddProject: FC<AddProjectProps> = ({ projectManager }) => {
    ...
    function openProjectInput() {
        return <ProjectForm projectManager={projectManager} initialData={projectData} onSubmit={() => {}} onCancel={() => {}}></ProjectForm>
    }


    return <button onClick={openProjectInput} className="flex flex-row gap-2 m-5 p-3 transition duration-100 hover:bg-gray-100 rounded active:bg-gray-200">
